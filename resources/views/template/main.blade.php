...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="{{asset('selvia/jpeg')}}" sizes="16x16" href="images/favicon.png">
    <title>SIM PENJUALAN XI RPL 2</title>
    <!-- Bootstrap Core CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="{{asset('images/selvia.jpeg')}}" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img src="{{asset('images/selvia.jpeg')}}" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                <!-- End Logo -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{asset('images/selvia.jpeg')}}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Pengguna</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('pengguna')}}">Data pengguna</a></li>
                                <li><a href="{{url('/pengguna/create')}}">Tambah Penggguna</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="" aria-expanded="false"><i class="fa fa-bookmark-o"></i><span class="hide-menu">Jenis</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('jenis')}}">Data jenis</a></li>
                                <li><a href="{{url('/jenis/create')}}">Tambah jenis</a></li>
                            </ul>
                        </li>
						...
						<li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Pembeli</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('pembeli')}}">Data pembeli</a></li>
                                <li><a href="{{url('pembeli/create')}}">Tambah data pembeli</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-money"></i><span class="hide-menu">Transaksi</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('penjualan')}}">data transaksi</a></li>
                                <li><a href="{{url('penjualan/create')}}">Tambah data transaksi</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-table"></i><span class="hide-menu">Laporan</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('/laporan')}}">Laporan per bulan</a></li>
                            </ul>
                        </li>
